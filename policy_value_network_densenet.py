...
class PolicyValueNetwork(nn.Module):
    def __init__(self, growth_rate=32, blocks=(10,), fcl=256):
        super(PolicyValueNetwork, self).__init__()
        self.conv1_1_1 = nn.Conv2d(in_channels=FEATURES1_NUM, out_channels=growth_rate, kernel_size=3, padding=1, bias=False)
        self.conv1_1_2 = nn.Conv2d(in_channels=FEATURES1_NUM, out_channels=growth_rate, kernel_size=1, padding=0, bias=False)
        self.conv1_2 = nn.Conv2d(in_channels=FEATURES2_NUM, out_channels=growth_rate, kernel_size=1, bias=False)
        channels=growth_rate*3+FEATURES1_NUM+FEATURES2_NUM
        self.norm1 = nn.BatchNorm2d(channels)
