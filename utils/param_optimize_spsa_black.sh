...
--games 50 \
--byoyomi 2000 \
--csa /volume/param_optimize/kifu/resnet35x512_spsa_black \
...
--spsa_r_end 0.01 \
--spsa_verify_games 0 \
--spsa_log /volume/param_optimize/log_spsa_black.jsonl \
--spsa_checkpoint /volume/param_optimize/spsa_black_checkpoint.json \
 | tee -a /volume/param_optimize/log_spsa_black.txt
