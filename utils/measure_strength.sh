...
--options1 PV_Interval:0,PV_Mate_Search_Threads:3,DNN_Model1:/root/models/model_resnet35x512-348.onnx,NetworkDelay2:0,MaxMovesToDraw:324 \
...
--opening /volume/measure_strength/yaneuraou_start/start_sfens.txt --draw 320 --time 0 --byoyomi 2000 --games 200 \
